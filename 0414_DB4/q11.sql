...
SELECT SELL.SELL_ID, SELL.SELLER_NAME, PRODUCT.PRODUCT_NAME, SELL.QUANTITY
FROM SELL
INNER JOIN PRODUCT
...
SELECT SELL.SELL_ID, SELL.SELLER_NAME, PRODUCT.PRODUCT_NAME, SELL.QUANTITY, PRODUCT.PRICE * SELL.QUANTITY AS TOTAL_SALES
FROM SELL
INNER JOIN PRODUCT
ON SELL.PRODUCT_ID = PRODUCT.PRODUCT_ID
ORDER BY SELL.SELL_ID;