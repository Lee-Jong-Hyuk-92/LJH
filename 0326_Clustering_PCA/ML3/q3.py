...
from sklearn.mixture import GaussianMixture # 가우시안 믹스쳐 알고리즘
from sklearn.datasets import make_blobs # 이건뭐지?
...
def K_means():
    ...
    fig.savefig("q3_kmeans_plot.png")
